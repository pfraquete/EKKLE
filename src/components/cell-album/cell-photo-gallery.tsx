                        ...
                        <div className="relative w-full h-full flex flex-col">
                            <div className="relative flex-1 flex items-center justify-center p-2 sm:p-4">
                                ...
                                <button
                                    ...
                                    className="absolute top-4 right-4 sm:top-8 sm:right-8 p-3 sm:p-4 bg-white/10 hover:bg-white/20 text-white rounded-full transition-all backdrop-blur-xl border border-white/10 shadow-2xl"
                                >
