...
import { BookOpen, Flame, ArrowRight, Calendar, Play, Clock, Users } from 'lucide-react'
...
export default async function EkkleBibliaOracaoPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 sm:space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      {/* Free Bible Reading */}
      <Link href="/ekkle/membro/biblia-oracao/leitor">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {availablePlans.map((plan) => (
                  <PlanCard
                    ...
                    href={`/ekkle/membro/biblia-oracao/planos/${plan.id}`}
                  />
                ))}
              </div>
            </section>
