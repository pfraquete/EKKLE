...
import { DeletePrayerButton } from '@/app/site/[domain]/membro/biblia-oracao/oracao/[id]/delete-button'
import { RefreshButton } from '@/app/site/[domain]/membro/biblia-oracao/oracao/[id]/refresh-button'

interface Props {
  params: Promise<{ id: string }>
}

export default async function EkklePrayerDetailPage({ params }: Props) {
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <div className="flex items-center justify-between">
        ...
        <DeletePrayerButton prayerId={prayer.id} redirectPath="/ekkle/membro/biblia-oracao/oracao" />
      </div>
