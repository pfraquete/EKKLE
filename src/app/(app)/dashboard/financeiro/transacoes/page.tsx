                ...
                <CardContent className="p-0">
                    ...
                    <table className="w-full text-sm min-w-[600px]">
                        <thead className="bg-muted/50 text-muted-foreground">
                            <tr>
                                <th className="text-left px-3 md:px-6 py-4 font-semibold uppercase tracking-wider text-xs">Data</th>
                                <th className="text-left px-3 md:px-6 py-4 font-semibold uppercase tracking-wider text-xs">Descrição / Categoria</th>
                                <th className="text-left px-3 md:px-6 py-4 font-semibold uppercase tracking-wider text-xs">Tipo</th>
                                <th className="text-right px-3 md:px-6 py-4 font-semibold uppercase tracking-wider text-xs">Valor</th>
                                <th className="text-center px-3 md:px-6 py-4 font-semibold uppercase tracking-wider text-xs">Ações</th>
                            </tr>
                        </thead>
                            ...
                            {transactions.length === 0 ? (
                                ...
                                transactions.map((tx) => (
                                    <tr key={tx.id} className="hover:bg-muted/30 transition-colors">
                                        ...
                                        <td className={`px-3 md:px-6 py-4 text-right font-bold ${tx.type === 'INCOME' ? 'text-green-600' : 'text-red-600'}`}>
