...
import { createEventPayment, checkEventPaymentStatus } from '@/actions/event-payments';
...
export default function EventCheckoutPage() {
  ...
  useEffect(() => {
    ...
    const interval = setInterval(async () => {
      ...
      const result = await checkEventPaymentStatus(pixData.order_id);
  ...
  }, [pixData?.order_id, eventId, router]);
        ...
        <Card>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="bg-muted rounded-lg p-4 text-center">
              ...
              <p className="text-2xl font-bold">{formatCurrency(event.price_cents)}</p>
            </div>
        ...
        <Card>
          ...
          <CardContent className="space-y-6">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <ol className="text-sm text-amber-700 mt-2 space-y-1 list-decimal list-inside">
                    ...
                    <li>O valor é de <strong>{formatCurrency(event.price_cents)}</strong></li>
            ...
            <p className="text-sm text-center text-muted-foreground">
              Após a confirmação do pagamento, sua inscrição estará confirmada.
            </p>
          </CardContent>
          <CardFooter>
            <Button 
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              >
                {isPending ? (
                  ...
                  `Pagar ${formatCurrency(event.price_cents)}`
                )}
              </Button>
            </form>
          </CardContent>
